    ...
    <header className="h-20 bg-bg-primary/95 backdrop-blur-sm px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-3">
          <button className="p-2.5 rounded-xl text-text-muted hover:bg-white hover:text-accent-primary transition-all border border-transparent hover:border-border-color">
